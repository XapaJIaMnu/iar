...
#Movement functions
def curveright(value):
    global speedleft
    global speedright

    speedleft = speedleft - value
    speedright = speedright + value
    s.write('D,' + str(speedleft) + ',' + str(speedright) + '\n')
    s.readline()
...
def followWall4():
    ...
    while(True):
       ...
       if not turnUntilNear and front <= keepdist:
